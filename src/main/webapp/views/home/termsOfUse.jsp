...
<head>
    ...
    <table width="1000" height="550" style="margin: auto; margin-bottom: 20px">
        <tr>
	...
	- 생성정보 수집 툴을 통한 수집
                ...
                <br>
                <input type="checkbox" id="req" style="margin-top: 10px;"> 개인정보 수집 및 이용에 동의합니다.
            </td>
        </tr>
        <tr>
            <td align="center" valign="top">
                <input type="button" value="동의" onclick="chk()"
                       style="width: 100px; heigth: 30px;background-color: hsl(209, 84%, 55%);border-radius: 3px; color: aliceblue; margin-top:15px;">&nbsp;&nbsp;&nbsp;
                <input type="button" value="동의하지 않습니다" onclick="nochk()" style="width: 150px; heigth: 30px; border-radius: 3px; margin-top:15px;">
            </td>
        </tr>
    </table>
    </body>
