...
<head>
    ...
    <table width="850" height="500" style="margin: auto; margin-bottom: 20px">
        <tr>
        ...
        <tr>
            <td align="center" valign="top">
                <input type="button" value="동의" onclick="chk()"
                       style="width: 100px;background-color: hsl(209, 84%, 55%);border-radius: 3px; color: aliceblue;">&nbsp;&nbsp;&nbsp;
                <input type="button" value="동의하지 않습니다" onclick="nochk()" style="width: 150px;border-radius: 3px;">
            </td>
        </tr>
    </table>
    </body>
